...
//-----------------------------------------------------------------------------
  ...
  //var AutoHidingNavbar    = require('bootstrap-autohidingnavbar');
...
// requires: templates
//-----------------------------------------------------------------------------
  var tpl         = require('text!share_tpl/shell_list.html');
...
////===========================================================================
  var ShellView = Backbone.View.extend({
    ...
    render: function () {
      ...
      require(['jquery', 'bootstrap', 'bootstrap-autohidingnavbar'], function ($) {
    ...
    changeChart: function() {
      ...
      this.$el.find('#curPT').html(pt.get('NAME') + '(' + pt.get('AGE') + ')');
